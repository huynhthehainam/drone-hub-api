...
namespace MiSmart.API.Migrations
{
    ...
    [Migration("20221223031436_AddHubFlightID")]
    partial class AddHubFlightID
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.DeviceModel", b =>
                {
                    ...
                    b.Property<List<string>>("SprayingModes")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.DeviceModelParam", b =>
                {
                    ...
                    b.Property<double>("YCentrifugal4Max")
                        .HasColumnType("double precision");

                    b.Property<double>("YCentrifugal4Min")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.LogDetail", b =>
                {
                    ...
                    b.Property<double>("VibeX")
                        .HasColumnType("double precision");

                    b.Property<double>("VibeY")
                        .HasColumnType("double precision");

                    b.Property<double>("VibeZ")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.LogFile", b =>
                {
                    ...
                    b.Property<DateTime?>("AnalyzingTime")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<double?>("DroneLogAnalyzingTaskID")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.LogReportResult", b =>
                {
                    ...
                    b.Property<int>("ResponsibleCompany")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MiSmart.DAL.Models.SecondLogReport", b =>
                {
                    b.HasOne("MiSmart.DAL.Models.LogFile", "LogFile")
                        .WithOne("SecondLogReport")
                        .HasForeignKey("MiSmart.DAL.Models.SecondLogReport", "LogFileID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
